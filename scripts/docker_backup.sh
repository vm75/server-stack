...
echo "last seven local backup files are saved in ${stackDir}/backups"
...
if [ -f ./backups/rclone ]; then
	...
	rclone sync -P ./backups --include "/backup*"  gdrive:/${stackName}BU/
